...
// each handler declares the specific node type it accepts, so the module can't
// be described as a uniform map without widening it here. Dispatch is by node
// type, which the Parser guarantees matches the handler's argument.
const handlerMap = handlers as unknown as Record<string, HandlerFn | undefined>
